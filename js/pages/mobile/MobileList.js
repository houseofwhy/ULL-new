    ...
    template: `
        <div class="mob-list m2-page-body">
            ...
            <section class="m2-hero">
                ...
                <p v-if="pageType === 'main'">The Main List contains all levels that are considered to be rate-worthy and as a result have a higher chance of being added to the Demonlist if they are verified.</p>
                <p v-else-if="pageType === 'future'">The Future List contains levels that are expected to be verified in approximately a year or less.</p>
                <p v-else>This list contains the entire ULL: levels that are of sufficient quality and have a possibility of being verified in the future.</p>
                <div class="m2-figs">
                            ...
                            <div class="m2-sum">
                                <div class="m2-sum__meters">
                                    ...
                                    <div class="u-meter">
                                        ...
                                        <div class="u-bar u-bar--alt"><i :style="verifBar(level)"></i></div>
                                    </div>
                                </div>
