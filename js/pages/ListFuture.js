    ...
    <main v-else class="page-list-new page-with-hero">
        ...
        <div class="level-container-new surface">
            <div class="level" v-if="level">
                <div>
                    <h1>{{ level.name }}</h1>
                    <div v-if="level.allLevelsRank || level.mainRank" class="cross-list-ranks" style="display:flex;align-items:center;gap:0.5rem;flex-wrap:wrap;font-family:'Lexend Deca',sans-serif;font-size:0.9rem;opacity:0.45;margin-top:0.35rem;">
