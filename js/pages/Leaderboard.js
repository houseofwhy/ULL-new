...
export default {
    ...
    template: `
        <main :class="loading ? 'surface' : 'page-list'">
            <Spinner v-if="loading" />

            <template v-else>
                <h2 class="type-label-lg" style="font-weight: normal; font-size: 24px; margin: 30px 0 0 0; letter-spacing: 0.45px; padding: 0 1rem;">
